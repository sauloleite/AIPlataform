...
| --- | ---------------------------------------------- | ------------------------------------------------------------------------------------- |
| M1  | The repository stops lying                     | A plan built on a false description of the system is a guess                          |
| M2  | Delivery is real, and CI defends it            | Helm ships 6 of 11 services; nothing in CI compares a route to its contract           |
| M3  | Connect what is already built                  | The bulkhead, the tool-argument schema and the TTFT heartbeat need wiring, not design |
